#!/usr/bin/env python3
"""Visualize anchor-level orientation samples and sanity checks.

This script renders reachability coverage, twist statistics, and diagnostic views for one anchor.
"""
...
CONFIG = {
    ...
    "anchor_id": 2500,
    # datasets
    "orient_h5": "data/aubo_i5_3mm/orientation.h5",
    "pos_h5": "data/aubo_i5_3mm/dataset_pos.h5",
    # output
    "out_dir": "outputs/orient_vis",
    "seed": 42,
